...
\begin{frame}{Example}
  ...
  \item \emph{Stationary points}: $\mathbf{x}^*=(4,0)$ and $\bar{ \mathbf{x}}=(3,1)$
  % \item $f''( \mathbf{x}) =\left[
  %     \begin{array}{ccc}
  %       1  & & 1   \\
  %       1 & & 4-6 x_2
  %     \end{array}
...
\begin{frame}{Example}
  ...
  \item $f(x) =\frac{1}{2} x_1^2 +x_1 x_2 +2 x_2^2 -4x_1-4 x_2-x_2^3$\\
  \item $f'(x)= (x_1+x_2-4,~x_1+4x_2-4-3x_2^2)$. \\
  \item Stationary points: $\mathbf{x}^*=(4,0)$ and $\bar{ \mathbf{x}}=(3,1)$
  \item $f''( \mathbf{x}) =\left[
      \begin{array}{ccc}
        1  & & 1   \\
        1 & & 4-6 x_2
  ...
  \item $f''(\mathbf{x}^*) =\left[
      \begin{array}{ccc}
        ...
        1 & & 4
      \end{array}
    \right]\succeq_{S^2_+} \mathbf{0}$
  \item $f''(\bar{\mathbf{x}}) =\left[
      \begin{array}{ccc}
        1  & & 1   \\
        1 & & -2
      \end{array}
    \right]\not\succeq_{S^2_+} \mathbf{0}$
...
\begin{frame}{Example}
  ...
  \item $f(x) =\frac{1}{2} x_1^2 +x_1 x_2 +2 x_2^2 -4x_1-4 x_2-x_2^3$\\
  \item $f'(x)= (x_1+x_2-4,~x_1+4x_2-4-3x_2^2)$. \\
  \item Candidates $\mathbf{x}^*=(4,0)$ and $\bar{ \mathbf{x}}=(3,1)$
  \item $f''( \mathbf{x}) =\left[
      \begin{array}{ccc}
        1  & & 1   \\
        1 & & 4-6 x_2
