...
\begin{frame}{Second-Order Necessary Condition}
  ...
  \item<4-> As $g'(0)=\iprod{f'(x^\star)}{h}=0$ (first-order condition), for every $\tau\in(0, T]$ there is a $t^\star$ with $g(\tau)= g(0) + g''(t^\star) \tau^2/2 < f(x^\star)$; contradicting local minimality
  \end{itemize}
