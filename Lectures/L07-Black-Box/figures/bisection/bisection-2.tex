...
\begin{tikzpicture}
  ...
  \begin{axis}[
    ...
    \addplot[mark=none, blue, samples=100, domain=-1:0] {1.21047+(x+0.5)*(-1.00356)};
    \node[circle, inner sep=1, fill=black] (f0) at (axis cs:-0.5,1.21047) {};
    \node[circle, inner sep=1, fill=black] (x0) at (axis cs:-0.5,0.5) {};
    \node[below] at (x0) {$x_0$};
    \draw[densely dotted] (x0) -- (f0);
    \draw[thick, draw=blue] (axis cs:1,0.5) -- (x0);
